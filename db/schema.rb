...
ActiveRecord::Schema[7.0].define(version: 2023_08_03_061617) do
  ...
  create_table "shipping_addresses", charset: "utf8", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["shipping_id"], name: "index_shipping_addresses_on_shipping_id"
  end
  ...
  add_foreign_key "shipping_addresses", "shippings"
