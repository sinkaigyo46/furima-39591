class Order
  ...
  attr_accessor :user_id, :item_id, :postal_code, :city_town, :street_number, :building_name, :phone_number, :prefecture_id, :token
  ...
  def save
    ...
    ShippingAddress.create(postal_code: postal_code, city_town: city_town, street_number: street_number, 
                           building_name: building_name, phone_number: phone_number, prefecture_id: prefecture_id, shipping: shipping.id)
  end
end
