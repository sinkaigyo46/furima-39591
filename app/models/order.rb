class Order
  include ActiveModel::Model
   attr_accessor :user, :item, :postal_code, :city_town, :street_number, :building_name, :phone_number, :shipping, :prefecture_id
  
   with_options presence: true do
    validates :item, :user, :city_town, :street_number 
